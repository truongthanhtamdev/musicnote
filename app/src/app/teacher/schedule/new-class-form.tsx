  ...
  if (!open) {
    return (
      <button
        ...
        className="w-full bg-brand-600 hover:bg-brand-700 text-white font-medium rounded-xl px-4 py-3 text-base"
      >
        + Thêm lớp học mới
      </button>
    );
    ...
    <div className="bg-white rounded-xl border border-slate-200 p-4">
      ...
      <form ref={formRef} action={formAction} className="space-y-3">
        ...
        <button
          type="submit"
          disabled={pending}
          className="w-full bg-brand-600 hover:bg-brand-700 disabled:opacity-60 text-white font-medium rounded-lg px-4 py-2.5 text-base"
        >
